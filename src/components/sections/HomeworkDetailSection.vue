<template>
    <div style="height: 100%; width: 100%; display: flex; flex-direction: column;">
        ...
        <div class="wrapper-teacher-content" v-if="$store.state.authority === 'teacher'">
            <el-tabs v-model="activeName" type="border-card"  v-if="!showStudentHomeworkDetail">
...
export default {
    ...
    data() {
        return {
            ...
            showStudentHomeworkDetail: false,
            activeName: '1',
    ...
    methods: {
        ...
        goBack() {
            if (this.showStudentHomeworkDetail === true) {
                this.showStudentHomeworkDetail = false;
            } else {
        ...
        handlePreview(index, row) {
            this.showStudentHomeworkDetail = true;
        }
    }
}
</script>
